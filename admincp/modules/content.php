<div class="content">
    <div class="box_contains">
        ...
        if (($tam == 'loaisp') && ($tam1 == 'lietke')) {
            include('modules/quanlyloaisp/lietke.php');
        } elseif (($tam == 'loaisp') && ($tam1 == 'sua')) {
            include('modules/quanlyloaisp/sua.php');
        } elseif (($tam == 'loaisp') && ($tam1 == 'them')) {
            include('modules/quanlyloaisp/them.php');
        } elseif (($tam == 'size_soluong') && ($tam1 == 'lietke')) {
            include('modules/quanlysize_soluong/lietke.php');
        } elseif (($tam == 'size_soluong') && ($tam1 == 'sua')) {
            include('modules/quanlysize_soluong/sua.php');
        } elseif (($tam == 'size_soluong') && ($tam1 == 'them')) {
            include('modules/quanlysize_soluong/them.php');
        ...
        } elseif (($tam == 'phanhoi') && ($tam1 == 'lietke')) {

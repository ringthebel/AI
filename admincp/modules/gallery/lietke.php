<?php
	$sql=mysqli_query($conn,"select * from sanpham where idsp='$_GET[id]'");
...
<table width="100%" border="1">
  <tr>
    <td width="158px">Tên sản phẩm</td>
    <td width="360px">Hình ảnh</td>
    <td width="215px">Gallery</td>
    <td>Quản lý</td>
  </tr>
  <tr>
    <td><?php echo $dong['tensp'] ?></td>
    <td><img src="modules/quanlysanpham/uploads/<?php echo $dong['hinhanh'] ?>" width="300" height="200"></td>
    <td>
    <?php
    ...
    ?>
        <p style="margin-bottom:10px;"><img src="modules/gallery/uploads/<?php echo $dong_gal['hinhanhsp'] ?>" width="150" height="100"></p>
      <?php
      }
	  }else{
